...
ADD COLUMN litc_ci_61 TINYINT NULL DEFAULT NULL,
...
('A', 'Return Processing', 0),
('B', 'Penalty Abatement', 1),
('C', 'Injured Spouse', 2),
('D', 'Backup Withholding', 3),
('E', 'Correspondence Exam', 4),
('F', 'Office or Field Exam', 5),
('G', 'Automated Underreporter (AUR)', 6),
('H', 'Automated Substitute-for-Return (ASFR)', 7),
('I', 'Audit Reconsideration', 8),
('J', 'Automated Collection System (ACS)', 9),
('K', 'Field Collection (RO)', 10),
('L', 'Offer-in-Compromise (OIC)', 11),
('M', 'Lien Unit', 12),
('N', 'Bankruptcy', 13),
('O', 'Exam Appeals', 14),
('P', 'Collection Due Process (CDP)', 15),
('Q', 'Collection Appeals Process (CAP)', 16),
('R', 'OIC Appeals', 17),
('S', 'Penalty Abatement Appeals', 18),
('T', 'Other Appeals', 19),
('U', 'US Tax Court', 20),
('V', 'Other Federal Courts', 21),
('W', 'Identity Protection Specialized Unit (IPSU)', 22),
('X', 'Innocent Spouse Unit', 23),
('Y', 'SS-8 Unit', 24),
('Z', 'ITIN Unit', 25), 
('AA', 'Trust Fund Recovery Penalty', 26);